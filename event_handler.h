...
void event_data(string&, string&, int&, int&, int&, int&, int&, int&);
...
void print_event(string&, string&, int&, int&, int&, int&, int&, int&, vector<string>&, vector<string>&, vector<string>&, vector<int>&, vector<int>&, vector<int>&, vector<int>&, vector<int>&);
